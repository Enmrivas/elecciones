<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        if(isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['correo']) && isset($_POST['usuario']) && isset($_POST['pass'])){
            ...
            $newUpdate = new UserAdmin();

            $newUpdate->initializeData($id, $_POST['nombre'], $_POST['apellido'], $_POST['correo'], $_POST['usuario'], $_POST['pass']);

            $service->Update($id, $newUpdate);
            ...
            <div class="card-body">
                ...
                <form action="edit.php?id=<?php echo $user->id ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $user->correo ?>" required type="email" class="form-control" id="correo" name="correo" placeholder="Correo Electronico">
                    </div>
                    <div class="form-group">
                        <label for="cedula">Usuario</label>
                        <input value="<?php echo $user->usuario ?>" required type="text" class="form-control" id="usuario" name="usuario" placeholder="Cedula">
                    </div>
                    <div class="form-group">
                        <label for="cedula">Contrase&ntilde;a</label>
                        <input value="<?php echo $user->pass ?>" required type="password" class="form-control" id="pass" name="pass" placeholder="Cedula">
                    </div>
